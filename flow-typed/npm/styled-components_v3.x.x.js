...
class $npm$styledComponents$ReactComponent<Props, DefaultProps> extends React$Component<
  Props,
> {
...
declare module 'styled-components/native' {
  ...
  declare type ReactComponentClassUndefinedDefaultProps<
    Props: {},
  > = $npm$styledComponents$ReactComponentClassUndefinedDefaultProps<Props>;
  declare type ReactComponentUnion<Props> = $npm$styledComponents$ReactComponentUnion<
    Props,
  >;
